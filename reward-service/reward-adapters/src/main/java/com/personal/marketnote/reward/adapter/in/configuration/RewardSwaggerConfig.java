package com.personal.marketnote.reward.adapter.in.configuration;
...
@Configuration
@Slf4j
public class RewardSwaggerConfig {
    @Value("${server.origin}")
    ...
    public OpenAPI apiV1() {
        ...
        openApi.info(new Info()
                        .title("마켓노트 리워드 API 서버")
                        .description("마켓노트 서비스 리워드 API 서버입니다.")
                        .version("1.0"))
