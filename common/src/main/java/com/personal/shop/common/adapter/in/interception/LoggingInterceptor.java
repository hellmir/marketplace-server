package com.personal.shop.common.adapter.in.interception;

import com.personal.shop.common.utility.PerformanceMeasurer;
...
import static com.personal.shop.common.application.aop.LogMessage.PERFORMANCE_MEASUREMENT;

public class LoggingInterceptor implements HandlerInterceptor {
    private static final Logger log = LoggerFactory.getLogger(com.personal.shop.common.adapter.in.interception.LoggingInterceptor.class);
