package com.personal.marketnote.fulfillment.adapter.out.persistence.servicecommunication.entity;
...
import com.personal.marketnote.fulfillment.domain.servicecommunication.*;
...
@Entity
@Table(name = "fulfillment_service_communication_failure_history")
@EntityListeners(value = AuditingEntityListener.class)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@AllArgsConstructor(access = AccessLevel.PRIVATE)
@Builder(access = AccessLevel.PRIVATE)
@Getter
public class FulfillmentServiceCommunicationHistoryJpaEntity {
    @Id
    ...
    public static FulfillmentServiceCommunicationHistoryJpaEntity from(FulfillmentServiceCommunicationHistory history) {
        return FulfillmentServiceCommunicationHistoryJpaEntity.builder()
                .id(history.getId())
    ...
    public FulfillmentServiceCommunicationHistory toDomain() {
        return FulfillmentServiceCommunicationHistory.from(
