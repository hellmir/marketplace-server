...
public record RegisterFasstoWarehousingResponse(
        ...
        List<RegisterFasstoWarehousingItemResponse> data,
    ...
    public boolean isSuccess() {
        return FormatValidator.hasValue(header) && header.isSuccess() && FormatValidator.hasValue(data)
                && data.stream().allMatch(RegisterFasstoWarehousingItemResponse::isSuccess);
    }
    ...
    public String resolveErrorMessage() {
        ...
        if (FormatValidator.hasValue(data)) {
            for (RegisterFasstoWarehousingItemResponse item : data) {
