...
group = "com.personal.marketnote.commerce.adapters"
version = "1.0.0"
description = "commerce service adapters"
...
dependencies {
    ...
    implementation(project(":commerce-service:commerce-application"))
    implementation(project(":commerce-service:commerce-domain"))
...
springBoot {
    mainClass.set("com.personal.marketnote.commerce.CommerceApplication")
    buildInfo()
}
