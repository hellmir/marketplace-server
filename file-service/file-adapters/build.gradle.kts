...
group = "com.personal.marketnote.file.adapters"
version = "1.0.0"
description = "file service adapters"
...
dependencies {
    ...
    implementation(project(":file-service:file-application"))
    implementation(project(":file-service:file-domain"))
...
springBoot {
    mainClass.set("com.personal.marketnote.file.FileApplication")
    buildInfo()
}

// `./gradlew :file-service:file-adapters:downloadRedisSources` 실행 시 소스 JAR를 로컬 캐시에 받음
