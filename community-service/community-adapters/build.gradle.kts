...
group = "com.personal.marketnote.community.adapters"
version = "1.0.0"
description = "community service adapters"
...
dependencies {
    ...
    implementation(project(":community-service:community-application"))
    implementation(project(":community-service:community-domain"))
...
springBoot {
    mainClass.set("com.personal.marketnote.community.CommunityApplication")
    buildInfo()
}
