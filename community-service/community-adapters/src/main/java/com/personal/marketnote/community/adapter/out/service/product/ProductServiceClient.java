package com.personal.marketnote.community.adapter.out.service.product;

import com.personal.marketnote.common.adapter.in.api.format.BaseResponse;
import com.personal.marketnote.common.adapter.out.ServiceAdapter;
import com.personal.marketnote.common.utility.FormatValidator;
import com.personal.marketnote.community.adapter.out.service.product.response.OrderedProductsResponse;
import com.personal.marketnote.community.adapter.out.service.product.response.ProductsInfoResponse;
...
public class ProductServiceClient implements FindProductByPricePolicyPort {
    ...
    private List<ProductsInfoResponse> unboxResponse(ResponseEntity<BaseResponse<OrderedProductsResponse>> response) {
        ...
        if (!FormatValidator.hasValue(content.products())) {
            return List.of();
        }
