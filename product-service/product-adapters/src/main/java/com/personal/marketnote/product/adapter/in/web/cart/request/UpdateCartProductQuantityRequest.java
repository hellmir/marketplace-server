...
public record UpdateCartProductQuantityRequest(
        ...
        @Schema(description = "변경할 상품 수량")
        @NotNull(message = "변경할 상품 수량은 필수입니다.")
        @Min(value = 1, message = "변경할 상품 수량은 1 이상이어야 합니다.")
        @Max(value = Short.MAX_VALUE, message = "변경할 상품 수량은 정수형 최대값을 초과할 수 없습니다.")
        Short newQuantity
) {
}
