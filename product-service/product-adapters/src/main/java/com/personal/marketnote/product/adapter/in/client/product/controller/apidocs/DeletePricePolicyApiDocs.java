...
@Operation(
        ...
        description = """
                ...
                | message | string | 처리 결과 | "상품 가격 정책 삭제 성공" |
...
public @interface DeletePricePolicyApiDocs {
}
