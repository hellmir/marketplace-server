...
@Inherited
@Operation(
        summary = "(비회원) 가격 정책 ID로 상품 상세 정보 조회",
        description = """
                작성일자: 2026-01-27
                ...
                | timestamp | string(datetime) | 응답 일시 | "2026-01-27T10:37:32.320824" |
                                ...
                                examples = @ExampleObject("""
                                        {
                                          "statusCode": 200,
                                          "code": "SUC01",
                                          "timestamp": "2026-01-27T23:36:07.671425",
                                          "content": {
                                            "productInfo": {
                                              "id": 30,
                                              "sellerId": 1,
                                ...
                                examples = @ExampleObject("""
                                        {
                                          "statusCode": 404,
                                          "code": "NOT_FOUND",
                                          "timestamp": "2026-01-27T13:32:26.542724",
                                          "content": null,
                                          "message": "가격 정책을 찾을 수 없습니다. 전송된 가격 정책 ID: 1"
                                        }
                                        """)
                        )
                )
        })
public @interface GetProductInfoByPricePolicyIdApiDocs {
}
