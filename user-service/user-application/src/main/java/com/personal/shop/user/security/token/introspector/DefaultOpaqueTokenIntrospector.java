package com.personal.shop.user.security.token.introspector;

import com.personal.shop.user.constant.PrimaryRole;
import com.personal.shop.user.domain.user.User;
import com.personal.shop.user.port.in.usecase.GetRoleInfoUseCase;
